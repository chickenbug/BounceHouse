...
/**
 * Servlet implementation class ViewAuctionsByBuyer
 */
@WebServlet(name = "ViewAuctionsByBuyer", urlPatterns = {"/ViewAuctionsByBuyer"})
public class ViewAuctionsByBuyer extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ViewAuctionsByBuyer() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			auctions = getAuctions.executeQuery("SELECT U.Username,A.AuctionID,A.CloseDate,A.ItemID FROM Auction A, User U WHERE "
					+ "(A.Completed = 1 AND A.WinnerID = U.UserID) ORDER BY U.Username;");
